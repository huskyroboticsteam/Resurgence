...
const double SLOW_DRIVE_THRESH = 1.5;
...
void assertApprox(double expectedThetaVel, double expectedXVel,
	...
	REQUIRE_THAT(actual.thetaVel, Catch::WithinAbs(expectedThetaVel, angleThresh));
...
TEST_CASE("DriveToWaypointCommand Test") {
	...
	navtypes::point_t target(3.0, 4.0, 1);
	...
	commands::DriveToWaypointCommand cmd(target, THETA_KP, NORMAL_DRIVE_SPEED,
										 SLOW_DRIVE_THRESH, DONE_THRESHOLD,
