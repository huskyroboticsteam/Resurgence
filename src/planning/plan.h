 ...
 * whatever algorithm they want. Note that the x and y coords will be in the robot's local
 * space, at the time of invoking this method.
 ...
 *
 * @param lidar_scan A vector of points given by the lidar scan. These should all be in robot
 * local space.
 * @param goal The goal point to pathfind towards. This is in robot local space.
 * @param goal_radius The maximum allowable distance to the goal.
 * @return A plan that takes the robot from its current position to the goal point.
