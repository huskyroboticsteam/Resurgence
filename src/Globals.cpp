...
kinematics::PlanarArmKinematics<2> planarArmKinematics =
	kinematics::PlanarArmKinematics<2>({0, 0}, {0, 0}, {0, 0}, 0.0, 0);
control::PlanarArmController<2> planarArmController = control::PlanarArmController<2>{{0, 0}, planarArmKinematics};
} // namespace Globals
