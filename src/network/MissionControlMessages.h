...
constexpr const char* SERVO_POWER_REQ_TYPE = "servoPowerRequest";
constexpr const char* SERVO_POSITION_REQ_TYPE = "servoPositionRequest";
constexpr const char* STEPPER_TURN_REQ_TYPE = "stepperTurnRequest";
constexpr const char* STEPPER_STEP_REQ_TYPE = "stepperStepRequest";
