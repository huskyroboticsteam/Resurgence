...
namespace lidar
{
LidarVis::LidarVis(int win_width, int win_height, std::vector<double> rgb)
	: view(win_height, win_width, CV_8UC3, cv::Scalar(rgb[0], rgb[1], rgb[2])),
	  bg_color(cv::Scalar(rgb[0], rgb[1], rgb[2])), win_width(win_width),
